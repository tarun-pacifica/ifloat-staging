function product_link(product) {
	...
	return '<a class="product" href="/products/' + product.id + '">' + product_image_make(image_urls[0], image_urls[1]) + title_lines.join(" ") + '<p>' + util_superscript('text', product.summary) + '</p> <hr class="terminator" /> </a>';
}
